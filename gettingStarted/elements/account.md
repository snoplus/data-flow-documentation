...
* ### Compute Canada Account 
  ...
  * After receiving your Compute Canada account, you can start to gain access to cedar following the steps below:
    ...
    * If you are allowed to access, try:
      ...
      echo $ID
      ```
    * Copy the ID generated by the command above, send this ID, your CC username and your public SSH key(click [here](./tools.md) to see detail) to erming.pei@computecanada.ca to get
* ### SnoLab Account
